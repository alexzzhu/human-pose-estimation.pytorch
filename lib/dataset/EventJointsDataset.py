...
class EventJointsDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        data_numpy = self.events[idx, ...].astype(np.float32)
        ...
        if data_numpy is None or image is None:
        ...
        c = c * joint_scale
        s = s * joint_scale
        image = cv2.resize(image, data_numpy.shape[1::-1])
